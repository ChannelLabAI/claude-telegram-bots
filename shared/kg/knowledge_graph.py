...
Usage:
    ...
    kg = KnowledgeGraph()
    kg.add_triple("老兔", "role", "CEO", valid_from="2020-01-01")
    kg.add_triple("Wes", "role", "shareholder", valid_from="2024-01-01")

    # Query: everything about 老兔
    kg.query_entity("老兔")

    # Query: what was true about Wes in mid-2024?
    kg.query_entity("Wes", as_of="2024-06-01")

    # Query: who has a "role" relationship?
    kg.query_relationship("role")

    # Invalidate: Wes's shareholder role ended
    kg.invalidate("Wes", "role", "shareholder", ended="2025-06-01")
"""
...
class KnowledgeGraph:
    ...
    def add_triple(
        ...
        Examples:
            add_triple("老兔", "role", "CEO", valid_from="2020-01-01")
            add_triple("Wes", "role", "shareholder", valid_from="2024-01-01")
