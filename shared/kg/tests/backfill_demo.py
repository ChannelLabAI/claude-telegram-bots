...
def backfill():
    ...
    facts = [
        ...
        ("老兔",        "role",          "CEO",        "2020-01-01", None,         "team-config"),
        ("Wes",         "role",          "shareholder","2024-01-01", "2025-06-01", "wiki/chl-equity"),
        ("Wes",         "role",          "LP",         "2025-06-01", None,         "wiki/chl-equity"),
        ("老兔",        "project_owner", "NOXCAT",     "2025-01-01", None,         "wiki"),
    ...
    # For Wes/shareholder: if valid_to wasn't set during insert (dedup path),
