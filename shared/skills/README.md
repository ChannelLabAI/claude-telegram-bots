...
| apple-design | emilkowalski/skills | commit 6bf2443 | anya 2026-07-18（單檔 SKILL.md 282 行純設計知識，零外呼/零腳本/無注入面） | **僅 twinkle**（老兔 7/18 指示安裝）。Apple WWDC 流體介面設計原則之 web 轉譯：spring 動效/手勢/1:1 拖曳/可中斷轉場/材質景深/字體排印/reduced-motion。與 DESIGN.md 分工：DESIGN.md 管品牌（色彩字體版式），此 skill 管互動手感，互補不衝突。 |
