...
source "/home/oldrabbit/.claude-bots/shared/bin/secrets-loader.sh" "ron-reviewer" "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# Start: reviewer (@ron_reviewer_bot)
...
BOT_NAME="ron-reviewer"
BOT_USERNAME="ron0003_bot"
