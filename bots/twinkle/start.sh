...
source "/home/oldrabbit/.claude-bots/shared/bin/secrets-loader.sh" "twinkle" "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# Start: twinkle / 星星人 (@TwinkleCHL_bot)
