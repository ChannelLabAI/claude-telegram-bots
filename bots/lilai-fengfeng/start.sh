...
source "/home/oldrabbit/.claude-bots/shared/bin/secrets-loader.sh" "fengfeng" "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# Start: lilai-fengfeng (@fanfan608bot)
...
BOT_NAME="lilai-fengfeng"
BOT_USERNAME="fanfan608bot"
