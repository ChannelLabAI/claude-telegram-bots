...
_L2_BLOCKS_DIR="$HOME/.claude-bots/bots/nicky-zhanglinghe/blocks"
...
BOT_NAME="nicky-zhanglinghe"
BOT_USERNAME="ZhangLingheAI_bot"
...
while [[ $RETRY -lt $MAX_RETRIES ]]; do
  ...
  env TELEGRAM_STATE_DIR="$STATE_DIR" \
    ...
    claude --dangerously-skip-permissions --model sonnet --channels plugin:telegram@claude-plugins-official &
  CLAUDE_PID=$!
  ...
  (
    ...
    _BOOT_TEXT="@${BOT_USERNAME} 启动自我检视"
