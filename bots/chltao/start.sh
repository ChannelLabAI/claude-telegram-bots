...
source "/home/oldrabbit/.claude-bots/shared/bin/secrets-loader.sh" "elon" "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# Start: chltao (@chltao_bot)
...
_L2_BLOCKS_DIR="$HOME/.claude-bots/bots/chltao/blocks"
