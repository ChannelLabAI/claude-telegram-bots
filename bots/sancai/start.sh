...
source "/home/oldrabbit/.claude-bots/shared/bin/secrets-loader.sh" "sancai" "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# Start: sancai (@threedishes_bot)
