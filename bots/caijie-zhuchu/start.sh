...
source "/home/oldrabbit/.claude-bots/shared/bin/secrets-loader.sh" "zhuchu" "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# Start: caijie-zhuchu (@CarrotAAA_bot)
...
_L2_BLOCKS_DIR="$HOME/.claude-bots/bots/caijie-zhuchu/blocks"
...
BOT_NAME="caijie-zhuchu"
BOT_USERNAME="CarrotAAA_bot"
