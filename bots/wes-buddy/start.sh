...
source "/home/oldrabbit/.claude-bots/shared/bin/secrets-loader.sh" "wes-buddy" "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# Start: wes-buddy (@Wes_buddy_bot)
...
_L2_BLOCKS_DIR="$HOME/.claude-bots/bots/wes-buddy/blocks"
