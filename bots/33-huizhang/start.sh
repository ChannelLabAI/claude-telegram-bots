...
source "/home/oldrabbit/.claude-bots/shared/bin/secrets-loader.sh" "33-huizhang" "$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# Start: 33-huizhang (@netero33_bot)
...
BOT_NAME="33-huizhang"
BOT_USERNAME="netero33_bot"
